...
//   creating sale order on clicking in Order button
    ...
    multiprint.SubmitOrderButton.include({
        ...
        button_click: function(){
            ...
            if(order.hasChangesToPrint()){
                order.printChanges();
                order.saveChanges();
                self.click_sale_1_order_button('confirmed');
            }
        },
        ...
        hook_create_sale_1_order_success: function (result) {
            framework.unblockUI();
//            this.pos.get('selectedOrder').destroy();
        },

        hook_create_sale_1_order_error: function (error, event) {
        framework.unblockUI();
